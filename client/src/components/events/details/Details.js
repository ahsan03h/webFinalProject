...
const Details = () => {
    ...
    window.hotel  = event.name;

    const handleBook = () => {
        history.push('/book'); // Change '/book' to the actual route you want to navigate to
    };

    const render = () => {

        const isCreator = admin; // Check if the user is the creator of the event
        const showBookButton = !isCreator;
       // const history = useHistory();
        ...
        return (
            <div className="Details">
                ...
                {/* Show the "Book" button if the conditions are met */}
                {showBookButton && (
